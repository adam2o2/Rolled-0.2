...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const romanceImages = [
        ...
        { src: 'villainess.png', video: 'https://www.youtube.com/embed/5cfNLZqPBiM', title: 'I\'m the Villainess, So I\'m Taming the Final Boss', episodes: '12 episodes' },
        { src: 'orange.png', video: 'https://www.youtube.com/embed/G9CzaN3WyKs', title: 'Orange', episodes: '13 episodes' },
        { src: 'horimiya.png', video: 'https://www.youtube.com/embed/W4C2ye5mK9g', title: 'My Stepmom\'s Daughter Is My Ex', episodes: '12 episodes' },
        { src: 'science.png', video: 'https://www.youtube.com/embed/4vJ33PVcsMM', title: 'Science Fell in Love, So I Tried to Prove It', episodes: '24 episodes' },
        { src: 'ourdating.png', video: 'https://www.youtube.com/embed/5Z824-bOhZA', title: 'Our Dating Story: The Experienced You and the Inexperienced Me', episodes: '12 episodes' },
        { src: 'lv999.png', video: 'https://www.youtube.com/embed/Mk8gEBzunD8', title: 'My Love Story With Yamada-kun at Lv999', episodes: '13 episodes' },
        { src: '100.png', video: 'https://www.youtube.com/embed/ls2VNcSifi4', title: 'The 100 Girlfriends Who Really, Really, Really, Really, Really Love You', episodes: '12 episodes' },
        { src: 'mywife.png', video: 'https://www.youtube.com/embed/slxnDYn0dPY', title: 'My Wife is the Student Council President', episodes: '24 episodes' },
        ...
        { src: 'hensuki.png', video: 'https://www.youtube.com/embed/a1BxLBr_O88', title: 'Hensuki: Are you willing to fall in love with a pervert, as long as she\'s a cutie?', episodes: '12 episodes' },
        ...
        { src: 'oresuki.png', video: 'https://www.youtube.com/embed/Pt3MqwiSyKY', title: 'ORESUKI Are you the only one who loves me?', episodes: '15 episodes' },
        ...
        { src: 'karakai.png', video: 'https://www.youtube.com/embed/jfckVPkj-Ok', title: 'KARAKAI JOZU NO TAKAGI-SAN', episodes: '12 episodes' },
...
const isekaiImages = [
    ...
    { src: 'Feature/vendingmachinecard.png', video: 'https://www.youtube.com/embed/mMOzW_UEdvg', title: 'Reborn as A Vending...', episodes: '12 episodes' },
    { src: 'Feature/yourmomcard.png', video: 'https://www.youtube.com/embed/8qoBfi8REs0', title: 'Do You Love Your...', episodes: '13 episodes' },
    { src: 'Feature/demonlordcard.png', video: 'https://www.youtube.com/embed/V0gQ4N6Y4bI', title: 'Demon Lord, Retry!', episodes: '13 episodes' },
    { src: 'Feature/summoncard.png', video: 'https://www.youtube.com/embed/hodocFdl5O8', title: 'How Not to Summon a Demon Lord', episodes: '22 episodes' },
    { src: 'Feature/restaurantcard.png', video: 'https://www.youtube.com/embed/j_4JaXWk1a4', title: 'Restaurant to Another World', episodes: '24 episodes' },
    { src: 'Feature/anothercard.png', video: 'https://www.youtube.com/embed/A1ll0D9J6II', title: 'In Another World...', episodes: '24 episodes' },
    { src: 'Feature/knightcard.png', video: 'https://www.youtube.com/embed/vR9N0c_SFAY', title: 'Knight’s & Magic', episodes: '13 episodes' },
    { src: 'Feature/realistcard.png', video: 'https://www.youtube.com/embed/M_pWteehKzM', title: 'How a Realist Hero Rebuilt the Kingdom', episodes: '26 episodes' },
    { src: 'Feature/millioncard.png', video: 'https://www.youtube.com/embed/U26Up23GGDk', title: 'Im Standing on a Million Lives', episodes: '24 episodes' },
    { src: 'Feature/gracecard.png', video: 'https://www.youtube.com/embed/ylms3zzyfuA', title: 'By the Grace of the Gods', episodes: '24 episodes' },
    { src: 'Feature/assassincard.png', video: 'https://www.youtube.com/embed/2Poci60rWzg', title: 'The Worlds Finest...', episodes: '12 episodes' },
    { src: 'Feature/cheatcard.png', video: 'https://www.youtube.com/embed/NH_lYSh38N8', title: 'Isekai Cheat Magician', episodes: '13 episodes' },
    { src: 'Feature/ascendancecard.png', video: 'https://www.youtube.com/embed/Wo28IopG2WE', title: 'Ascendance of a Bookworm', episodes: '36 episodes' },
    { src: 'Feature/deathcard.png', video: 'https://www.youtube.com/embed/L4VW38PLuOc', title: 'Death March to the Parallel World Rhapsody', episodes: '12 episodes' },
    { src: 'Feature/wisecard.png', video: 'https://www.youtube.com/embed/gy-78Y-chds', title: 'Wise Mans Grandchild', episodes: '12 episodes' },
    { src: 'Feature/seireicard.png', video: 'https://www.youtube.com/embed/KS7dinNk_z4', title: 'Seirei Gensouki', episodes: '12 episodes' },
    { src: 'Feature/grimgarcard.png', video: 'https://www.youtube.com/embed/aR0UcWq_JrY', title: 'Grimgar, Ashes and Illusions', episodes: '12 episodes' },
    { src: 'Feature/ambitioncard.png', video: 'https://www.youtube.com/embed/_Q-qoxLfk48', title: 'The Ambition of Oda Nobuna', episodes: '12 episodes' },
    { src: 'Feature/conceptioncard.png', video: 'https://www.youtube.com/embed/8jUGg1yjmLU', title: 'Conception', episodes: '12 episodes' },
    { src: 'Feature/mastercard.png', video: 'https://www.youtube.com/embed/mVd2HX5oVRk', title: 'The Master of Ragnarok...', episodes: '12 episodes' },
    { src: 'Feature/highcard.png', video: 'https://www.youtube.com/embed/QSFXJzpEpqs', title: 'High School Prodigies...', episodes: '12 episodes' },
    { src: 'Feature/sweetcard.png', video: 'https://www.youtube.com/embed/uPYEALVBhI8', title: 'Sweet Reincarnation', episodes: '12 episodes' },
    { src: 'Feature/reincarnationcard.png', video: 'https://www.youtube.com/embed/NNrCwPAj1IY', title: 'The Reincarnation of...', episodes: '13 episodes' },
    { src: 'Feature/didntcard.png', video: 'https://www.youtube.com/embed/39XpskL3jic', title: 'Didnt I Say to...', episodes: '12 episodes' },
    { src: 'Feature/irumacard.png', video: 'https://www.youtube.com/embed/kkeuJt0DE7g', title: 'Welcome to Demon...', episodes: '65 episodes' },
    { src: 'Feature/chillincard.png', video: 'https://www.youtube.com/embed/IwxaZRkXdps', title: 'Chillin in Another...', episodes: '12 episodes' },
    { src: 'Feature/skeletoncard.png', video: 'https://www.youtube.com/embed/dPzd8VNbQQI', title: 'Skeleton Knight...', episodes: '12 episodes' },
    { src: 'Feature/drugcard.png', video: 'https://www.youtube.com/embed/reOfMXg3kqs', title: 'Drug Store in...', episodes: '12 episodes' },
    { src: 'Feature/endridecard.png', video: 'https://www.youtube.com/embed/4yzMnwxt3yQ', title: 'Endride', episodes: '24 episodes' },
    { src: 'Feature/campfirecard.png', video: 'https://www.youtube.com/embed/JaxjIDezSBQ', title: 'Campfire Cooking in...', episodes: '12 episodes' },
    { src: 'Feature/saintcard.png', video: 'https://www.youtube.com/embed/JwsnFH4XRsU', title: 'The Saints Magic...', episodes: '24 episodes' },
    { src: 'Feature/meijicard.png', video: 'https://www.youtube.com/embed/F1LDCFKTbqU', title: 'Meiji Tokyo Renka', episodes: '12 episodes' },
    { src: 'Feature/collectioncard.png', video: 'https://www.youtube.com/embed/kUcgIqI0_kE', title: 'Sengoku Collection', episodes: '26 episodes' },
    { src: 'Feature/sengokucard.png', video: 'https://www.youtube.com/embed/fAYhdawxFwc', title: 'SENGOKU NIGHT BLOOD', episodes: '12 episodes' },
    { src: 'Feature/problemcard.png', video: 'https://www.youtube.com/embed/qQpOcHsMUnA', title: 'Problem Children...', episodes: '10 episodes' },
    { src: 'Feature/tobecard.png', video: 'https://www.youtube.com/embed/z2WARBz4QXc', title: 'To Be Heroine', episodes: '7 episodes' }
];
